    ...
    private void parseResult(JSONArray jsonArray) {
        for (int i= 0; i<jsonArray.length(); i++){
            try {
                ...
                data.setImage(object.getString("download_url")); //here string must be match with json url like "download_url"
                data.setName(object.getString("author")); //here string must be match with json url like - "author"
